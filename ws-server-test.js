...
var mongoSv = new mongoSave(cfg.config.mongo.server,cfg.config.mongo.port,cfg.config.mongo.database,cfg.config.mongo.collection,wsServer,cfg.config.mongo.saveOn);
wsServer.start();
mongoSv.listen();
